<?php
    ...
    $errors     = fetchErrors();
    $activeItem = isset($_GET['item']) ? members()->findById($_GET['item']) : null;
...
<div class="container-fluid body-content p-0 m-0">
    ...
    <div class="container p-4">
        ...
        <div class="row mt-4">
            <div class="col-sm-12">
                <form action="members-processors.php" method="POST" class="bg-light rounded p-4">
                    ...
                    <div class="form-group">
                        <label for="first_name">JMBG:</label>

                        <input type="text"
                               class="form-control"
                               id="jmbg"
                               name="jmbg"
                               value="<?php if ($activeItem) echo $activeItem->jmbg ?>">
                    </div>
